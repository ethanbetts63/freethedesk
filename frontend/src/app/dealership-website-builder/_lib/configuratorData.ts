...
export const MODULES: ModuleDefinition[] = [
  {
    ...
    includes: [
      "Make, model, price and condition filters",
      "Detailed vehicle pages and enquiries",
      "Compatible with online sales options",
    ],
  },
  {
    key: "accessories",
    ...
    includes: [
      "Categories, search and product pages",
      "Vehicle-compatible recommendations",
  ...
  },
  {
    ...
    includes: ["Year, make and model lookup", "Clickable numbered diagrams", "Part details and online ordering"],
  },
  {
    key: "service",
    ...
    includes: [
      ...
      "Confirmations and reminder workflows",
    ],
  },
  {
    key: "hire",
    ...
    includes: [
      "Date-based fleet availability",
      "Rates, deposits and reservations",
      "Customer details and hire agreements",
    ],
  },
  {
    key: "articles",
  ...
  },
  {
    key: "seo",
    name: "Continuous SEO",
    description: "Measure, learn and improve over time.",
    detail:
      "We apply strong technical foundations at launch, then use real search data to make gradual, evidence-led improvements.",
    includes: [
      "Technical and on-page foundations",
      "Search performance monitoring",
      "Ongoing content and page improvements",
    ],
  },
  {
    key: "integrations",
    name: "System integrations",
    description: "Connect stock, CRM and existing tools.",
    detail:
      "Connect the website to the systems your dealership already relies on so information moves without double handling.",
    includes: ["Inventory and DMS connections", "CRM and enquiry routing", "Custom API and workflow support"],
  },
];
...
export const INVENTORY_OPTIONS: InventoryOptionDefinition[] = [
  {
    ...
    description: "Deposits or full payment from a stock item.",
    detail:
      "Customers can move from a vehicle listing into a guided checkout and complete as much of the purchase as your dealership allows.",
    includes: [
      "Deposit or full-payment journeys",
      "Optional delivery or collection",
      "Secure customer and order records",
    ],
  },
  {
    key: "contract",
    name: "Online sales contract",
    description: "Complete and sign the vehicle sales contract.",
    detail:
      "Move the sales agreement online with a clear, guided process for reviewing details and collecting signatures.",
    includes: [
      "Pre-filled customer and vehicle details",
  ...
  },
  {
    ...
    description: "Identity, licensing forms and signatures online.",
    detail:
      "Collect the information and approvals required for licensing without making the customer visit the dealership.",
    includes: [
      "Guided identity and licence details",
  ...
  {
    key: "newsletter",
    name: "New stock newsletter",
    description: "Capture buyers waiting for the right vehicle.",
    detail:
      "Place a simple signup above the inventory list so interested buyers can hear about newly listed vehicles before they miss them.",
...
export function summariseSelection(
  ...
  const modules = MODULES.filter((module) => selected[module.key]);
  const addons = selected.inventory ? INVENTORY_OPTIONS.filter((option) => inventoryAddons[option.key]) : [];
  ...
  return {
    ...
    addons,
    hasCustomRequest,
    additionCount: modules.length + addons.length + Number(hasCustomRequest),
    names: [
      ...modules.map((module) => module.name),
      ...addons.map((addon) => addon.name),
      ...(hasCustomRequest ? ["Custom capability"] : []),
    ],
  };
}
