...
export const SEO_FAQS: FaqItem[] = [
...

  {
    ...
    answer:
      "The report says so and recommends you cancel, or drop to a slower cadence. We'd rather lose the money than keep charging for attention your data doesn't need yet.",
  },
