  ...
  return [
    {
      ...
      features: ["A report every month", "Google Business Profile audit included", "AI readiness check included"],
    },
    {
      code: "quarterly",
      name: "Quarterly",
      ...
      features: [
        "A report every three months",
        "Google Business Profile audit included",
        "AI readiness check included",
      ],
      recommended: true,
    },
    {
      ...
      features: ["A report every six months", "Google Business Profile audit included", "AI readiness check included"],
    },
    {
      code: "oneoff",
      name: "One-off report",
      ...
      features: ["One report, paid once", "Google Business Profile audit included", "AI readiness check included"],
    },
  ];
}
