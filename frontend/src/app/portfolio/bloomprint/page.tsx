...
export default function BloomprintCaseStudy() {
  return (
    <main className="case-page">
      <PageSchema path="/portfolio/bloomprint" />
      ...
      <section className="case-hero">
        ...
        <div className="shell case-hero-layout">
          <div className="case-hero-copy">
            ...
            <p>
              A national flower delivery marketplace where the customer describes what they want and an independent
              local florist designs it. Customer ordering, florist supply and organic growth built as one product.
            </p>
            <div className="button-row">
              <a
                className="button button-primary"
                href="https://www.bloomprint.com.au/"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <section className="section shell case-story-intro">
        ...
        <div>
          ...
          <p>
            Online flower delivery usually means scrolling near-identical warehouse bouquets and hoping the photo
            resembles what turns up. Bloomprint works the other way around: the customer sets the occasion, the budget
            and their preferences, and an independent florist near the recipient designs to that brief from what is
            fresh that day.
          </p>
          <p>
            That is a harder website. It needs an ordering experience that captures intent instead of a product ID, a
            supply-side product that convinces working florists to sign up, and enough of a search presence to sell a
            name nobody is looking up yet.
          </p>
      ...
      <section className="case-operations-section">
        <div className="shell">
          <div className="case-operations-heading">
            ...
            <p>
              A customer journey that ends in a beautiful order is worthless if no florist wants to make it. Both sides
              were designed together, so what the customer is asked for is exactly what the florist needs to start work.
            </p>
          </div>
          ...
          <div className="bloom-sides">
            <article className="bloom-side">
              <header>
                <small>Demand</small>
                <h3>The customer</h3>
                <p>Describes the outcome and pays once — no catalogue, no surprises at checkout.</p>
              </header>
              <ol>
            ...
            <article className="bloom-side bloom-side-alt">
              <header>
                <small>Supply</small>
                <h3>The florist</h3>
                <p>Gets paid work near the shop with the creative freedom to design it properly.</p>
              </header>
              <ol>
      ...
      <section className="section shell bloom-split">
        <div className="bloom-split-copy">
          ...
          <p>
            Most flower sites reveal the real price at checkout. Here the customer names the amount — a tier or any
            custom figure — and that is what they pay, with delivery included over $100. It removes the biggest reason
            gift buyers abandon an order, and it gives the florist a firm number to design against.
          </p>
          <div className="bloom-split-points">
            <span>Customer-set budgets</span>
            <span>Delivery included over $100</span>
            <span>No checkout markup</span>
            <span>A firm brief for the florist</span>
          </div>
        </div>
        <div className="bloom-split-media">
          <div className="case-browser">
            <div className="case-browser-bar">
              ...
              <i />
              <i />
              <span>www.bloomprint.com.au/pricing</span>
            </div>
            <Image
      ...
      <section className="bloom-seo-section">
        <div className="shell bloom-split bloom-split-reverse">
          <div className="bloom-split-copy">
            ...
            <p>
              Nobody searches for a marketplace that launched last month. They search for flower delivery in their city,
              for a subscription, for Mother&apos;s Day, or for a comparison of who is actually any good. The content
              and landing page structure was built around those searches from the first sprint, not bolted on later.
            </p>
            <div className="bloom-split-points">
              <span>City landing pages</span>
              <span>Occasion pages</span>
          ...
          <div className="bloom-split-media">
            <div className="case-browser">
              <div className="case-browser-bar">
                ...
                <i />
                <i />
                <span>www.bloomprint.com.au/articles</span>
              </div>
              <Image
      ...
      <section className="case-intent-section">
        <div className="shell">
          <div className="case-intent-heading">
            ...
            <p>
              Each page speaks to a different search, then hands the visitor the same order builder — already framed
              around their city, their occasion or the way they want flowers to arrive. New front doors can be added
              without rebuilding the thing behind them.
            </p>
          </div>
      ...
      <section className="shell closing-cta">
        ...
        <p>
          Marketplaces, booking flows, portals and anything with two audiences. Tell us what the business actually has
          to do and we&apos;ll show you how it would work.
        </p>
        <div className="button-row">
          <Link className="button button-lime" href="/contact">
            Talk about your build <span>→</span>
          </Link>
          <a className="case-cta-live-link" href="https://www.bloomprint.com.au/" target="_blank" rel="noreferrer">
            Visit Bloomprint ↗
          </a>
        </div>
      </section>
