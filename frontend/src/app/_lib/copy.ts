...
export const HOME_FAQS: FaqItem[] = [
...

  {
    ...
    answer:
      "Start with the outcome or the repeated task—not a technical specification. Show us what takes too long, gets copied by hand or makes customers work harder than they should, and we'll help define the useful first step.",
  },
