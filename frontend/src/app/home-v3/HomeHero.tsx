  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={`shell ${styles.content}`}>
        ...
        <div className={styles.actions}><Link className={styles.primary} href="/website-builder">Build your system <span>↗</span></Link><Link className={styles.secondary} href="/work/scooter-shop">See it in action <span>→</span></Link></div>
      </div>
